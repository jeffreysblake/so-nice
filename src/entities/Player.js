...
export class Player extends Phaser.Physics.Arcade.Sprite {
     ...
     */
    updateAnimation() {
        const animationName = getSonicAnimationForState(this.physicsState.isGrounded, this.physicsState.isRolling, this.physicsState.isJumping, this.physicsState.groundSpeed);
    ...
    checkDeathConditions() {
        if (!this.lifeSystem || this.lifeSystem.isPlayerDead())
            return;
