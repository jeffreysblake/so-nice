...
describe('Heightmap Diagnostic - Verify Sonic 1 Format', () => {
    ...
    beforeAll(async () => {
        ...
        loader.loadFromBuffers(normalData.buffer.slice(normalData.byteOffset, normalData.byteOffset + normalData.byteLength), rotatedData.buffer.slice(rotatedData.byteOffset, rotatedData.byteOffset + rotatedData.byteLength), angleData.buffer.slice(angleData.byteOffset, angleData.byteOffset + angleData.byteLength));
    });
