...
export class ScoreSystem {
  ...
  private time: number = 0; // Time in frames (60fps)
  private isRunning: boolean = false;

  // Scoring constants
  private readonly RING_POINTS = 10;
  private readonly ENEMY_POINTS = 100;
  private readonly CHECKPOINT_POINTS = 500;
  ...
  calculateTimeBonus(): number {
    ...
    if (seconds < 30) return 50000;
    else if (seconds < 45) return 10000;
    else if (seconds < 60) return 5000;
    else if (seconds < 90) return 4000;
    else if (seconds < 120) return 3000;
    else if (seconds < 180) return 2000;
    else if (seconds < 240) return 1000;
    else if (seconds < 300) return 500;
    else return 0;
  }
   ...
   */
  calculateRingBonus(rings: number): number {
    return rings * 100;
  }
