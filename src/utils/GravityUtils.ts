...
export class GravityUtils {
   ...
   */
  static getGravityModeFromAngle(angle: number): GroundMode {
   ...
   */
  static getGravityVector(mode: GroundMode): { x: number; y: number } {
    switch (mode) {
   ...
   */
  static shouldFallOff(groundSpeed: number, groundAngle: number, mode: GroundMode): boolean {
   ...
   */
  static getSensorOffsets(mode: GroundMode): {
