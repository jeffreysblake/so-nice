 ...
 */
export function createSonicAnimation(scene, textureKey, config) {
    ...
    config.frames.forEach((frame, index) => {
        ...
        if (!texture.has(frameName)) {
            texture.add(frameName, 0, // sourceIndex - always 0 for single images
 ...
 */
export function initializeSonicAnimations(scene, textureKey = 'sonic-spritesheet') {
 ...
 */
export function getSonicAnimationForState(isGrounded, isRolling, isJumping, groundSpeed) {
    // Jumping/in air
